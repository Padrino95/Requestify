        ...
        <?php
            ...
            if ($nombre != "" && $nick != "" && $pass != "") {
                if ($_FILES['imagen']['error'] === UPLOAD_ERR_NO_FILE) {
                    $editor = new editor();
                    $editores = $editor->modificarEditorSinFoto($_POST["id"], $nombre, $_POST["presentacion"], $nick, $_POST["tipo"], $pass, $_POST["estiloE"]);
                    ...
                    $editor = new editor();
                    move_uploaded_file($_FILES['imagen']['tmp_name'], "../assets/imagenes/editores/$_POST[id].$extension");
                    ...
                    header("refresh:20; url=../controladores/admin_listar_editores.php");
                }
            } else {
                header("refresh:0; url=./admin_modificar_editor.php?error=1");
            }
        } else {
            $estilo= new estilo();
            $estilos= $estilo->listarEstilos();
            include("../vistas/admin_modificar_editor.php");
        }
        ?>
    </main>
