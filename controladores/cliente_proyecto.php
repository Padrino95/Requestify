...
<body>
    ...
    <main>
        ...
        if (isset($_GET['cod'])) {
            ...
            $editadas= $multimedia2->listarFotosProyectoEditadas($_GET['cod']);
            $editor = new editor();
            $nombre = $editor->buscarEditorPorId($_GET['cod_editor']);
            $multimedia2 = new multimedia();
            $destacada = $multimedia2->imagenDestacadaProyecto($_GET['cod']);
            include("../vistas/cliente_proyecto.php");
        } else {
